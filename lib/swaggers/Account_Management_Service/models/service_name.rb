...
module AccountManagementService
  class ServiceName
    ...
    # Validity start date of of this service
    attr_accessor :startdate

    # Validity end date of this Service name
    ...
    def list_invalid_properties
      ...
      if !@startdate.nil? && @startdate.to_s.length > 10
        invalid_properties.push('invalid value for "startdate", the character length must be smaller than or equal to 10.')
      end

      if !@enddate.nil? && @enddate.to_s.length > 10
        invalid_properties.push('invalid value for "enddate", the character length must be smaller than or equal to 10.')
      end
    ...
    def valid?
      ...
      return false if !@startdate.nil? && @startdate.to_s.length > 10
      return false if !@enddate.nil? && @enddate.to_s.length > 10
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] startdate Value to be assigned
    def startdate=(startdate)
      if !startdate.nil? && startdate.to_s.length > 10
        fail ArgumentError, 'invalid value for "startdate", the character length must be smaller than or equal to 10.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] enddate Value to be assigned
    def enddate=(enddate)
      if !enddate.nil? && enddate.to_s.length > 10
        fail ArgumentError, 'invalid value for "enddate", the character length must be smaller than or equal to 10.'
      end
