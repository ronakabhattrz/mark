...
module AccountManagementService
  class ACCSCapPercentage
	include ActiveModel::Model
    # Start Date of ACCS CWB cap percentage
    attr_accessor :start_date

    # End Date of ACCS CWB cap percentage
    attr_accessor :end_date

    # ACCS Child Wellbeing cap percentage
    attr_accessor :percentage

    # Supporting information for this request
    attr_accessor :supporting_information
    ...
    def self.swagger_types
      {
        ...
        :'reason' => :'String',
        :'agencies' => :'RelatedCollectionAgency'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'supportingInformation')
        self.supporting_information = attributes[:'supportingInformation']
      end
      ...
      if attributes.has_key?(:'Agencies')
        self.agencies = attributes[:'Agencies']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@percentage.nil? && @percentage.to_s.length > 3
        invalid_properties.push('invalid value for "percentage", the character length must be smaller than or equal to 3.')
      end

      if !@supporting_information.nil? && @supporting_information.to_s.length > 255
        invalid_properties.push('invalid value for "supporting_information", the character length must be smaller than or equal to 255.')
      end
    ...
    def valid?
      ...
      return false if !@percentage.nil? && @percentage.to_s.length > 3
      return false if !@supporting_information.nil? && @supporting_information.to_s.length > 255
    ...
    def percentage=(percentage)
      if !percentage.nil? && percentage.to_s.length > 3
        fail ArgumentError, 'invalid value for "percentage", the character length must be smaller than or equal to 3.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] supporting_information Value to be assigned
    def supporting_information=(supporting_information)
      if !supporting_information.nil? && supporting_information.to_s.length > 255
        fail ArgumentError, 'invalid value for "supporting_information", the character length must be smaller than or equal to 255.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supporting_information == o.supporting_information &&
          reason == o.reason &&
          agencies == o.agencies
    end
    ...
    def hash
      [start_date, end_date, percentage, supporting_information, reason, agencies].hash
    end
