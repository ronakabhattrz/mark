...
module AccountManagementService
  class RecordsToBeProvided
    ...
    def list_invalid_properties
      ...
      if !@record.nil? && @record.to_s.length > 255
        invalid_properties.push('invalid value for "record", the character length must be smaller than or equal to 255.')
      end
    ...
    def valid?
      return false if !@record.nil? && @record.to_s.length > 255
      true
    end
    ...
    def record=(record)
      if !record.nil? && record.to_s.length > 255
        fail ArgumentError, 'invalid value for "record", the character length must be smaller than or equal to 255.'
      end
