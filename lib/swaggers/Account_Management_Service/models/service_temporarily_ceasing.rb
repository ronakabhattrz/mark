...
module AccountManagementService
  class ServiceTemporarilyCeasing
	include ActiveModel::Model
    # Start date of closure
    attr_accessor :start_date

    # Expected end date of closure
    attr_accessor :end_date

    # Action for Temporary Ceasing
    attr_accessor :action

    # Temporarily ceasing reason code
    attr_accessor :reason

    # Temporarily ceasing reason Text
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reasonText')
        self.reason_text = attributes[:'reasonText']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@reason_text.nil? && @reason_text.to_s.length > 250
        invalid_properties.push('invalid value for "reason_text", the character length must be smaller than or equal to 250.')
      end
    ...
    def valid?
      ...
      return false if !@reason_text.nil? && @reason_text.to_s.length > 250
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] reason_text Value to be assigned
    def reason_text=(reason_text)
      if !reason_text.nil? && reason_text.to_s.length > 250
        fail ArgumentError, 'invalid value for "reason_text", the character length must be smaller than or equal to 250.'
      end
    ...
    def hash
      [start_date, end_date, action, reason, reason_text].hash
    end
