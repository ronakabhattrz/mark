...
module AccountManagementService
  class Trustee
    ...
    # Validity start date of this Service Trustee relationship
    attr_accessor :start_date

    # Validity end date of this Service Trustee relationship
    attr_accessor :end_date

    # Action for this Trustee
    ...
    def hash
      [start_date, end_date, action, abn, name].hash
    end
